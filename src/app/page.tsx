              ...
              <div key={product.id} className="group bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden animate-float" style={{ animationDelay: `${product.id * 200}ms` }}>
                <div className="relative aspect-square overflow-hidden">
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center z-20">
                    <div className="bg-white/90 backdrop-blur-sm px-6 py-4 rounded-full transform -translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                      <p className="text-gray-900 font-medium">Xem chi tiết</p>
                    </div>
                  </div>
                </div>
                <div className="p-6 relative">
                  ...
                  <button className="w-full bg-pink-600 text-white py-3 rounded-full hover:bg-pink-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg font-medium flex items-center justify-center space-x-2 group">
